...
// Legacy Copilot setup - disabled for TARX
...
export const walkthroughs: GettingStartedWalkthroughContent = [
	{
		id: 'Setup',
		title: localize('gettingStarted.setup.title', "Get Started with Workbench"),
		description: localize('gettingStarted.setup.description', "Local. Private. Proactive. Start coding with AI that runs on your machine."),
		isFeatured: true,
		icon: setupIcon,
		when: '!isWeb',
		walkthroughPageTitle: localize('gettingStarted.setup.walkthroughPageTitle', 'Setup Workbench'),
		next: 'Beginner',
		content: {
			type: 'steps',
			steps: [
				{
					id: 'openTarxChat',
					title: localize('gettingStarted.tarxChat.title', "Chat with TARX"),
					description: localize('gettingStarted.tarxChat.description.interpolated', "TARX runs Qwen 8.2B locally on your machine. No cloud required.\n{0}", Button(localize('openChat', "Open Chat"), 'command:workbench.action.chat.open')),
					completionEvents: [
						'onCommand:workbench.action.chat.open'
					],
					media: { type: 'svg', altText: 'TARX Local AI', path: 'learn.svg' },
				},
				{
					id: 'tarxMemory',
					title: localize('gettingStarted.tarxMemory.title', "Use Memory"),
					description: localize('gettingStarted.tarxMemory.description.interpolated', "TARX remembers across sessions. Say 'remember this' in chat to save context.\n{0}", Button(localize('checkMemory', "Check System Status"), 'command:workbench.action.showCommands')),
					media: { type: 'svg', altText: 'TARX Memory', path: 'learn.svg' },
				},
				{
					id: 'tarxKnowledge',
					title: localize('gettingStarted.tarxKnowledge.title', "Upload Knowledge"),
					description: localize('gettingStarted.tarxKnowledge.description', "Upload documentation files. TARX will search them semantically using local embeddings."),
					media: { type: 'svg', altText: 'TARX Knowledge Base', path: 'learn.svg' },
				},
				{
					id: 'pickColorTheme',
	...
	{
		id: 'SetupWeb',
		title: localize('gettingStarted.setupWeb.title', "Get Started with Workbench"),
		description: localize('gettingStarted.setupWeb.description', "Customize your editor, learn the basics, and start coding"),
		isFeatured: true,
		icon: setupIcon,
		when: 'isWeb',
		next: 'Beginner',
		walkthroughPageTitle: localize('gettingStarted.setupWeb.walkthroughPageTitle', 'Setup Workbench'),
		content: {
			type: 'steps',
			steps: [
				{
				...
				},
				{
					...
					description: localize('gettingStarted.extensionsWeb.description.interpolated', "Extensions are Workbench's power-ups. A growing number are becoming available in the web.\n{0}", Button(localize('browsePopularWeb', "Browse Popular Web Extensions"), 'command:workbench.extensions.action.showPopularExtensions')),
					when: 'workspacePlatform == \'webworker\'',
					media: {
				...
				},
				{
					...
					description: localize('gettingStarted.commandPalette.description.interpolated', "Run commands without reaching for your mouse to accomplish any task in Workbench.\n{0}", Button(localize('commandPalette', "Open Command Palette"), 'command:workbench.action.showCommands')),
					media: { type: 'svg', altText: 'Command Palette overlay for searching and executing commands.', path: 'commandPalette.svg' },
				},
				{
					id: 'pickAFolderTask-WebWeb',
					title: localize('gettingStarted.setup.OpenFolder.title', "Open up your code"),
					description: localize('gettingStarted.setup.OpenFolderWeb.description.interpolated', "You're all set to start coding. You can open a local project or a remote repository to get your files into Workbench.\n{0}\n{1}", Button(localize('openFolder', "Open Folder"), 'command:workbench.action.addRootFolder'), Button(localize('openRepository', "Open Repository"), 'command:remoteHub.openRepository')),
	...
	},
	{
		...
		description: localize('gettingStarted.setupAccessibility.description', "Learn the tools and shortcuts that make Workbench accessible. Note that some actions are not actionable from within the context of the walkthrough."),
		isFeatured: true,
		icon: setupIcon,
		when: CONTEXT_ACCESSIBILITY_MODE_ENABLED.key,
		next: 'Setup',
		walkthroughPageTitle: localize('gettingStarted.setupAccessibility.walkthroughPageTitle', 'Setup Workbench Accessibility'),
		content: {
			type: 'steps',
			steps: [
				{
				...
				},
				{
					...
					description: localize('gettingStarted.commandPaletteAccessibility.description.interpolated', "Run commands without reaching for your mouse to accomplish any task in Workbench.\n{0}", Button(localize('commandPalette', "Open Command Palette"), 'command:workbench.action.showCommands')),
		...
		content: {
			...
			steps: [
				...
				},
				{
					id: 'extensions',
					title: localize('gettingStarted.extensions.title', "Code with extensions"),
					description: localize('gettingStarted.extensions.description.interpolated', "Extensions are Workbench's power-ups. They range from handy productivity hacks, expanding out-of-the-box features, to adding completely new capabilities.\n{0}", Button(localize('browsePopular', "Browse Popular Extensions"), 'command:workbench.extensions.action.showPopularExtensions')),
					when: 'workspacePlatform != \'webworker\'',
					media: {
